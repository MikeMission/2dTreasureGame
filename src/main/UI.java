...
public class UI {
    ...
    BufferedImage heart_full, heart_half, heart_empty, crystal_full, crystal_empty, coin;
    ...
    public void trade_buy() {
        ...
        drawSubWindow(x, y, width, height);
        g2.drawString("Your Coin:" + gp.player.coin ,x+32 , y+60);
        ...
        if (itemIndex < npc.inventory.size()) {
            ...
            if (gp.keyH.enterPressed) {
                if (npc.inventory.get(itemIndex).price > gp.player.coin) {
                    ...
                    subState = 0;
                    gp.gameState = gp.dialogueState;
                    currentDialogue = "You cannot afford that silly.";
                    drawDialogueScreen();
                }
    ...
    public void options_top(int frameX, int frameY) {
        ...
        g2.setColor(Color.white);
        g2.drawString(text, getXforCenteredText(text) - 30, textY);
        ...
        if (commandNum == 0) {
            ...
            if (gp.keyH.enterPressed && !gp.fullScreenOn) {
                gp.fullScreenOn = true;
            }
            else if (gp.fullScreenOn && gp.keyH.enterPressed) {
        ...
        textY += gp.tileSize;
        g2.setStroke(new BasicStroke(3));
        g2.drawRect(textX, textY, 135,24); // 135/5 = 27
        int volumeWidth = 27 * gp.music.volumeScale;
        g2.fillRect(textX, textY, volumeWidth, 24);

        //  SFX CHECK BOX
        textY += gp.tileSize;
        g2.setStroke(new BasicStroke(3));
        g2.drawRect(textX, textY, 135,24);
        volumeWidth = 27 * gp.se.volumeScale;
        g2.fillRect(textX, textY, volumeWidth, 24);
